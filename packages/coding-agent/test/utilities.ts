...
// ============================================================================
// OAuth API key resolution from ~/.bengacoon/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".bengacoon", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.bengacoon/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.bengacoon/agent/auth.json
 */
...
/** Path to the real Bengacoon agent config directory. */
export const BENGACOON_AGENT_DIR = join(homedir(), ".bengacoon", "agent");

/**
 * Get an AuthStorage instance backed by ~/.bengacoon/agent/auth.json
